...
with open("inserts.txt", "w") as out:
    ...
    for i in range(num):
        ...
        # followers
        followers = [u for u in usernames[random.randint(0, num):random.randint(0, num)]]
        while not followers:
            followers = [u for u in usernames[random.randint(0, num):random.randint(0, num)]]

        line = "INSERT INTO followers (vid_id, title, followers) VALUES (\'{}\', \'{}\', {});\n".format(vid_ids[i], "title " + str(i), followers)
        out.write(line)
